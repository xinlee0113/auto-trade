...
def test_get_quote():
    ...
    print(bars)
    print(f"获取股票K线数据{bars}")
    ticks = openapi_client.get_trade_ticks(['00700'])
    print(ticks)
    print(f"获取股票逐笔成交数据数据{ticks}")
